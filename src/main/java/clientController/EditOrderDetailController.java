...
/**
 * Servlet implementation class EditOrderDetailController
 */
@WebServlet("/EditOrderDetailController")
public class EditOrderDetailController extends HttpServlet {
     ...
     */
    public EditOrderDetailController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("delete")) {
				...
				response.sendRedirect("OrderController?action=view&orderID="+orderID);
				return;
		}
		
		RequestDispatcher rd = request.getRequestDispatcher("OrderController?action=view&orderID="+orderID);
