        ...
        <div class="row">
            ...
            <main id="content" class="col-md-10 ms-sm-auto col-lg-10 content">
               <div class="container mt-2">
				    ...
				    <div class="mx-auto">
				    <form action="SaveEditController" method="Get">
					    <span style="color: red;">${error}</span>
					    <input type="hidden" name="id" value="${factory.getFactoryID() }" />
				         <div class="modal-body">
				             <div class="mb-3">
				                    <label for="factoryName" class="form-label">Tên loại hàng</label>
				                    <input type="text" class="form-control" id="factoryName" name="factoryName" value="${factory.getFactoryName() }" required>
				             </div>
				         </div>
